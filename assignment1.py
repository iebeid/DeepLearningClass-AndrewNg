...
def load_dataset():
    train_dataset = h5py.File('D:/Projects/UT/CourseraDeepLearningClass/Sources/PycharmProjects/DeepLearningClass/datasets/train_catvnoncat.h5', "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])  # your train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File('D:/Projects/UT/CourseraDeepLearningClass/Sources/PycharmProjects/DeepLearningClass/datasets/test_catvnoncat.h5', "r")
...
def propagate(w, b, X, Y):
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    Z_first_part = np.dot(w.T, X)
    Z = Z_first_part + b
    # Z = (w.T * X) + b
    A = sigmoid(Z)  # compute activation
    loss_part_1 = (Y * np.log(A))
    loss_part_2 = ((1 - Y) * np.log(1 - A))
