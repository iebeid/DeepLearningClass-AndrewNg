...
from utils import testCases_v3 as tc
from utils import dnn_utils_v2 as dnn
...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    if activation == "sigmoid":
        ...
        A, activation_cache = dnn.sigmoid(Z)
        ### END CODE HERE ###
...
X, parameters = tc.L_model_forward_test_case_2hidden()
...
dZ, linear_cache = tc.linear_backward_test_case()
...
AL, Y_assess, caches = tc.L_model_backward_test_case()
grads = L_model_backward(AL, Y_assess, caches)
tc.print_grads(grads)
