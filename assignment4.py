...
from utils import dnn_app_utils_v2 as dnn
...
def two_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=3000, print_cost=False):
    ...
    parameters = dnn.initialize_parameters(n_x, n_h, n_y)
    ### END CODE HERE ###
    ...
    for i in range(0, num_iterations):
        ...
        A1, cache1 = dnn.linear_activation_forward(X, W1, b1, "relu")
        A2, cache2 = dnn.linear_activation_forward(A1, W2, b2, "sigmoid")
        ### END CODE HERE ###
        ...
        ### START CODE HERE ### (≈ 2 lines of code)
        dA1, dW2, db2 = dnn.linear_activation_backward(dA2, cache2, "sigmoid")
        dA0, dW1, db1 = dnn.linear_activation_backward(dA1, cache1, "relu")
        ### END CODE HERE ###
...
predictions_train = dnn.predict(train_x, train_y, parameters)


predictions_test = dnn.predict(test_x, test_y, parameters)
